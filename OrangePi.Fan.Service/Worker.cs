...
namespace OrangePi.Fan.Service
{
    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            await _processRunner.WaitForOutputAsync(command: "gpio", new string[] { "mode", _serviceConfigMonitor.CurrentValue.WiringPi.ToString(), "pwm" });
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                if (previousValue != value)
                {
                    ...
                    await _processRunner.WaitForOutputAsync(command: "gpio", new string[] { "pwm", _serviceConfigMonitor.CurrentValue.WiringPi.ToString(), value.ToString() });
                }
            ...
            await _processRunner.WaitForOutputAsync(command: "gpio", new string[] { "pwm", _serviceConfigMonitor.CurrentValue.WiringPi.ToString(), _serviceConfigMonitor.CurrentValue.ValueToSetOnExit.ToString() });
        }
    }
}