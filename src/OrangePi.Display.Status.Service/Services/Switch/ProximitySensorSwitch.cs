...
namespace OrangePi.Display.Status.Service.Services.Switch
{
    public class ProximitySensorSwitch : ISwitch
    {
        ...
        public Task StartMonitoringAsync(CancellationToken stoppingToken)
        {
            ...
            {
                var _i2cSettings = new I2cConnectionSettings(busId: _config.BusId, deviceAddress: _config.DeviceAddress);
                // Alternatively use Vl53L1X.DefaultI2cAddress or use
                // sudo i2cdetect -y <busId>
                // to get the address hex
